...
import com.back.chap.components.map.EventPopup
import com.back.chap.components.map.MappableItemPopup
import com.back.chap.components.map.PostPopup
import com.back.chap.components.map.SpotPopup
import com.back.chap.components.map.ThreadPopup
...
sealed class MarkerType<T : Mappable>(
    ...
    object Post : MarkerType<com.back.chap.models.Post>("pin-post", "Post")
    object Thread : MarkerType<com.back.chap.models.Thread>("pin-thread", "Thread")
    object Event : MarkerType<com.back.chap.models.Event>("pin-event", "Event")
    object Spot : MarkerType<com.back.chap.models.Spot>("pin-spot", "Spot")
}
